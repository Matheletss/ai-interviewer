...
def text_to_speech(text: str) -> bytes:
    response = requests.post(
        ...
        json={
            ...
            "model": "bulbul:v2",       # Optional, safe default
            "speaker": "anushka",        # Optional, customize if needed
            "pitch": 0.5,                # Range: -0.75 to 0.75
            "loudness": 0.8,               # Range: 0.1 to 3
            "pace": 0.9,                   # Range: 0.3 to 3
    ...
    print("API Key Loaded:", SARVAM_API_KEY)  
